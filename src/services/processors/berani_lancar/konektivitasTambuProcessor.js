...
const process = async (tx, headerId, filePath) => {
    ...
    if (rawData.length === 0) throw new Error("Excel Peningkatan Konektivitas Tambu Kasimbar kosong");
    ...
    await tx.realisasiKonektivitasTambu.createMany({ data: detailData });
