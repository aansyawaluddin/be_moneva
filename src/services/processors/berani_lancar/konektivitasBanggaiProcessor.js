...
const process = async (tx, headerId, filePath) => {
    ...
    if (rawData.length === 0) throw new Error("Excel Peningkatan Konektivitas Banggai Kepulauan kosong");
    ...
    await tx.realisasiKonektivitasBanggai.createMany({ data: detailData });
